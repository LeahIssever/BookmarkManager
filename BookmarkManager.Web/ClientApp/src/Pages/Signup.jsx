        ...
        <div className="row" style={{ minHeight: "80vh", display: "flex", alignItems: "center" }}>
            <div className="col-md-6 offset-md-3 bg-light p-4 rounded shadow">
                ...
                <form onSubmit={onFormSubmit}>
                    <input type="text" onChange={onTextChange} value={formData.firstName} name="firstName" placeholder="First Name" className="form-control" />
                    <br />
                    <input type="text" onChange={onTextChange} value={formData.lastName} name="lastName" placeholder="Last Name" className="form-control" />
                    <br />
